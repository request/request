...
tape('recursive defaults', function (t) {
  ...
  let defaultsOne = request.defaults({ headers: { foo: 'bar1' } })
  let defaultsTwo = defaultsOne.defaults({ headers: { baz: 'bar2' } })
  let defaultsThree = defaultsTwo.defaults({}, function (options, callback) {
    options.headers = {
      foo: 'bar3'
    }
...
tape('recursive defaults requester', function (t) {
  ...
  let defaultsOne = request.defaults({}, function (options, callback) {
  ...
  let defaultsTwo = defaultsOne.defaults({}, function (options, callback) {
    var headers = options.headers || {}
    headers.baz = 'bar2'
    options.headers = headers
