...
// Disabling camelCase because these relate to OAuth standard names.
/* eslint-disable camelcase */
let hmacsign = oauth.hmacsign
let rsasign = oauth.rsasign
let rsa_private_pem = fs.readFileSync(path.join(__dirname, 'ssl', 'test.key'))
let reqsign
let reqsign_rsa
let accsign
let accsign_rsa
