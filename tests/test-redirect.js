...
tape(
  'should follow post redirects when followallredirects true and followOriginalHttpMethod is enabled',
  t => {
    hits = {}
    request.post(
      {
...
tape('should not follow delete redirects by default', t => {
  ...
  request.del(
    ...
    (err, res, body) => {
      t.equal(err, null)
      t.ok(
        res.statusCode >= 301 && res.statusCode < 400,
  ...
  request(
    ...
    (err, res, body) => {
      ...
      t.equal(
        ...
        s.url + '/double_2',
        'Current location should be ' + s.url + '/double_2'
      )
      t.end()
    }
  )
  ...
  request(
    ...
    (err, res, body) => {
      ...
      t.equal(
        res.headers.location,
        s.url + '/treble_3',
        'Current location should be ' + s.url + '/treble_3'
      )
      t.end()
    }
  )
...
tape(
  'should preserve referer header set in the initial request when removeRefererHeader is true',
  t => {
    request
      .post(
        {
