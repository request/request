...
function handleAuth(self, options) {
  if (options.oauth) {
...
function handleBody(self, options) {
  var body = self.body
...
function initRequest(options, extras) {
  ...
  uri = constructObject(uri).extend(baseUrlProps.uri).done()
  ...
  handleAuth(self, options)
  handleBody(self, options)
