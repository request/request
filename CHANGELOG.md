...
- [#1199](https://github.com/request/request/pull/1199) Fix lint error: undeclared let i (@nylen)
...
- [#844](https://github.com/request/request/pull/844) Add support for HTTP[S]_PROXY environment letiables.  Fixes #595. (@jvmccarthy)
...
- [#732](https://github.com/request/request/pull/732) JSHINT: Creating global 'for' letiable. Should be 'for (let ...'. (@Fritz-Lium)
...
- [#67](https://github.com/request/request/pull/67) fixed global letiable leaks (@aheckmann)
