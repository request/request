...
- [#946](https://null/mikeal/request/pull/946) defaults: merge headers (@aj0strow)
- [#844](https://null/mikeal/request/pull/844) Add support for HTTP[S]_PROXY environment variables.  Fixes #595. (@jvmccarthy)
...
- [#907](https://null/mikeal/request/pull/907) append secureOptions to poolKey (@medovob)
...
- [#927](https://null/mikeal/request/pull/927) Bump version of hawk dep. (@samccone)
...
- [#943](https://null/mikeal/request/pull/943) New mime module (@eiriksm)
...
- [#944](https://null/mikeal/request/pull/944) Make request work with browserify (@eiriksm)
...
- [#949](https://null/mikeal/request/pull/949) Manually enter querystring in form option (@charlespwd)
...
- [#951](https://null/mikeal/request/pull/951) Add support for gzip content decoding (@kevinoid)
...
- [#955](https://null/mikeal/request/pull/955) check for content-length header before setting it in nextTick (@camilleanne)
- [#957](https://null/mikeal/request/pull/957) Silence EventEmitter memory leak warning #311 (@watson)
...
- [#815](https://null/mikeal/request/pull/815) Create changelog based on pull requests (@lalitkapoor)
...
- [#821](https://null/mikeal/request/pull/821) added secureOptions back (@nw)
...
- [#840](https://null/mikeal/request/pull/840) improve error reporting for invalid protocols (@FND)
- [#810](https://null/mikeal/request/pull/810) add some exposition to mpu example in README.md (@mikermcneil)
...
- [#850](https://null/mikeal/request/pull/850) Fix word consistency in readme (@0xNobody)
- [#809](https://null/mikeal/request/pull/809) upgrade tunnel-proxy to 0.4.0 (@ksato9700)
...
- [#861](https://null/mikeal/request/pull/861) Add support for RFC 6750 Bearer Tokens (@phedny)
- [b8ee579](https://github.com/mikeal/request/commit/b8ee5790ace95440a56074f6afe866f4662e9e88) Fix typo (@dandv)
- [#866](https://null/mikeal/request/pull/866) Fix typo (@dandv)
...
- [#869](https://null/mikeal/request/pull/869) Pipefilter test (@tgohn)
...
- [#891](https://null/mikeal/request/pull/891) fixes 857 - options object is mutated by calling request (@lalitkapoor)
...
- [#897](https://null/mikeal/request/pull/897) merge with default options (@vohof)
- [a1e4b1a](https://github.com/mikeal/request/commit/a1e4b1a9c2f39ce565fd023bb604da139f689d43) Fixes #555 (@pigulla)
- [#901](https://null/mikeal/request/pull/901) Fixes #555 (@pigulla)
...
- [#781](https://null/mikeal/request/pull/781) simpler isReadStream function (@joaojeronimo)
...
- [#785](https://null/mikeal/request/pull/785) Provide ability to override content-type when `json` option used (@vvo)
...
- [#793](https://null/mikeal/request/pull/793) Adds content-length calculation when submitting forms using form-data li... (@Juul)
...
- [#802](https://null/mikeal/request/pull/802) Added the Apache license to the package.json. (@keskival)
- [#801](https://null/mikeal/request/pull/801) 794 ignore cookie parsing and domain errors (@lalitkapoor)
...
- [#516](https://null/mikeal/request/pull/516) UNIX Socket URL Support (@native-digital)
...
- [#757](https://null/mikeal/request/pull/757) require aws-sign2 (@mafintosh)
- [#744](https://null/mikeal/request/pull/744) Use Cookie.parse (@lalitkapoor)
...
- [#763](https://null/mikeal/request/pull/763) Upgrade tough-cookie to 0.10.0 (@stash)
...
- [#764](https://null/mikeal/request/pull/764) Case-insensitive authentication scheme (@bobyrizov)
...
- [#767](https://null/mikeal/request/pull/767) Use tough-cookie CookieJar sync API (@stash)
...
- [#736](https://null/mikeal/request/pull/736) Fix callback arguments documentation (@mmalecki)
...
- [#741](https://null/mikeal/request/pull/741) README example is using old cookie jar api (@emkay)
...
- [#742](https://null/mikeal/request/pull/742) Add note about JSON output body type (@iansltx)
...
- [#745](https://null/mikeal/request/pull/745) updating setCookie example to make it clear that the callback is required (@emkay)
...
- [#746](https://null/mikeal/request/pull/746) README: Markdown code highlight (@weakish)
- [#645](https://null/mikeal/request/pull/645) update twitter api url to v1.1 (@mick)
...
- [#728](https://null/mikeal/request/pull/728) Fix TypeError when calling request.cookie (@scarletmeow)
...
- [#730](https://null/mikeal/request/pull/730) better HTTP DIGEST support (@dai-shi)
...
- [#732](https://null/mikeal/request/pull/732) JSHINT: Creating global 'for' variable. Should be 'for (var ...'. (@Fritz-Lium)
...
- [#727](https://null/mikeal/request/pull/727) fix requester bug (@jchris)
...
- [#630](https://null/mikeal/request/pull/630) Send random cnonce for HTTP Digest requests (@wprl)
...
- [#659](https://null/mikeal/request/pull/659) fix failure when running with NODE_DEBUG=request, and a test for that (@jrgm)
...
- [#662](https://null/mikeal/request/pull/662) option.tunnel to explicitly disable tunneling (@seanmonstar)
- [#656](https://null/mikeal/request/pull/656) Test case for #304. (@diversario)
...
- [#666](https://null/mikeal/request/pull/666) make `ciphers` and `secureProtocol` to work in https request (@richarddong)
- [524e035](https://github.com/mikeal/request/commit/524e0356b73240409a11989d369511419526b5ed) change cookie module (@sxyizhiren)
- [#674](https://null/mikeal/request/pull/674) change cookie module,to tough-cookie.please check it . (@sxyizhiren)
...
- [#683](https://null/mikeal/request/pull/683) Travis CI support (@Turbo87)
...
- [#682](https://null/mikeal/request/pull/682) Optional dependencies (@Turbo87)
...
- [#690](https://null/mikeal/request/pull/690) Handle blank password in basic auth. (@diversario)
- [33100c3](https://github.com/mikeal/request/commit/33100c3c7fa678f592374f7b2526fe9a0499b6f6) Typo (@VRMink)
- [#694](https://null/mikeal/request/pull/694) Typo in README (@ExxKA)
...
- [#696](https://null/mikeal/request/pull/696) Edited README.md for formatting and clarity of phrasing (@Zearin)
...
- [#710](https://null/mikeal/request/pull/710) Fixing listing in callback part of docs. (@lukasz-zak)
...
- [#715](https://null/mikeal/request/pull/715) Request.multipart no longer crashes when header 'Content-type' present (@pastaclub)
...
- [#719](https://null/mikeal/request/pull/719) Made a comment gender neutral. (@oztu)
...
- [#724](https://null/mikeal/request/pull/724) README.md: add custom HTTP Headers example. (@tcort)
...
- [#619](https://null/mikeal/request/pull/619) decouple things a bit (@CrowdProcess)
...
- [#605](https://null/mikeal/request/pull/605) Only include ":" + pass in Basic Auth if it's defined (fixes #602) (@bendrucker)
...
- [#613](https://null/mikeal/request/pull/613) Fixes #583, moved initialization of self.uri.pathname (@lexander)
...
- [#601](https://null/mikeal/request/pull/601) Fixed a small typo (@michalstanko)
- [#594](https://null/mikeal/request/pull/594) Emit complete event when there is no callback (@RomainLK)
- [#596](https://null/mikeal/request/pull/596) Global agent is being used when pool is specified (@Cauldrath)
...
- [#31](https://null/mikeal/request/pull/31) Error on piping a request to a destination (@tobowers)
...
- [#35](https://null/mikeal/request/pull/35) The "end" event isn't emitted for some responses (@voxpelli)
...
- [#45](https://null/mikeal/request/pull/45) Added timeout option (@mbrevoort)
...
- [#53](https://null/mikeal/request/pull/53) Parse json: Issue #51 (@benatkin)
...
- [#66](https://null/mikeal/request/pull/66) Do not overwrite established content-type headers for read stream deliver (@voodootikigod)
...
- [#67](https://null/mikeal/request/pull/67) fixed global variable leaks (@aheckmann)
...
- [#69](https://null/mikeal/request/pull/69) Flatten chunked requests properly (@isaacs)
- [#73](https://null/mikeal/request/pull/73) Fix #71 Respect the strictSSL flag (@isaacs)
- [#70](https://null/mikeal/request/pull/70) add test script to package.json (@isaacs)
...
- [#76](https://null/mikeal/request/pull/76) Bug when a request fails and a timeout is set (@Marsup)
...
- [#78](https://null/mikeal/request/pull/78) Don't try to do strictSSL for non-ssl connections (@isaacs)
...
- [#81](https://null/mikeal/request/pull/81) Enhance redirect handling (@danmactough)
...
- [#96](https://null/mikeal/request/pull/96) Authless parsed url host support (@isaacs)
...
- [#97](https://null/mikeal/request/pull/97) Typo in previous pull causes TypeError in non-0.5.11 versions (@isaacs)
...
- [#102](https://null/mikeal/request/pull/102) Implemented cookies - closes issue 82: https://github.com/mikeal/request/issues/82 (@alessioalex)
...
- [#105](https://null/mikeal/request/pull/105) added test for proxy option. (@dominictarr)
...
- [#86](https://null/mikeal/request/pull/86) Can't post binary to multipart requests (@developmentseed)
- [4e4d428](https://github.com/mikeal/request/commit/4e4d4285490be20abf89ff1fb54fb5088c01c00e) Update to Iris Couch URL (@jhs)
- [#110](https://null/mikeal/request/pull/110) Update to Iris Couch URL (@iriscouch)
...
- [#117](https://null/mikeal/request/pull/117) Remove the global `i` (@3rd-Eden)
...
- [#121](https://null/mikeal/request/pull/121) Another patch for cookie handling regression (@jhurliman)
...
- [#104](https://null/mikeal/request/pull/104) Cookie handling contains bugs (@janjongboom)
...
- [#112](https://null/mikeal/request/pull/112) Support using a custom http-like module (@iriscouch)
...
- [#132](https://null/mikeal/request/pull/132) return the body as a Buffer when encoding is set to null (@jahewson)
...
- [#135](https://null/mikeal/request/pull/135) host vs hostname (@iangreenleaf)
...
- [#133](https://null/mikeal/request/pull/133) Fixed cookies parsing (@afanasy)
...
- [#144](https://null/mikeal/request/pull/144) added "form" option to readme (@petejkim)
...
- [#146](https://null/mikeal/request/pull/146) Multipart should respect content-type if previously set (@apeace)
- [#148](https://null/mikeal/request/pull/148) Retry Agent (@thejh)
...
- [#90](https://null/mikeal/request/pull/90) add option followAllRedirects to follow post/put redirects (@jroes)
...
- [#162](https://null/mikeal/request/pull/162) Fix issue #159 (@dpetukhov)
...
- [#161](https://null/mikeal/request/pull/161) Fix cookie jar/headers.cookie collision (#125) (@papandreou)
- [#168](https://null/mikeal/request/pull/168) Picking off an EasyFix by adding some missing mimetypes. (@serby)
...
- [#170](https://null/mikeal/request/pull/170) can't create a cookie in a wrapped request (defaults) (@fabianonunes)
...
- [#177](https://null/mikeal/request/pull/177) Issue #173 Support uri as first and optional config as second argument (@twilson63)
...
- [#179](https://null/mikeal/request/pull/179) fix to add opts in .pipe(stream, opts) (@substack)
- [#180](https://null/mikeal/request/pull/180) Modified the post, put, head and del shortcuts to support uri optional param (@twilson63)
...
- [#182](https://null/mikeal/request/pull/182) Fix request.defaults to support (uri, options, callback) api (@twilson63)
...
- [#176](https://null/mikeal/request/pull/176) Querystring option (@csainty)
...
- [#188](https://null/mikeal/request/pull/188) Add abort support to the returned request (@itay)
...
- [#193](https://null/mikeal/request/pull/193) Fixes GH-119 (@goatslacker)
...
- [#197](https://null/mikeal/request/pull/197) Make ForeverAgent work with HTTPS (@isaacs)
- [8d85b57](https://github.com/mikeal/request/commit/8d85b57ebb81c9d2d0a6b94aed41bf2ab0e3ad09) Forever inherits bugfix (@isaacs)
- [#198](https://null/mikeal/request/pull/198) Bugfix on forever usage of util.inherits (@isaacs)
...
- [#199](https://null/mikeal/request/pull/199) Tunnel (@isaacs)
...
- [#203](https://null/mikeal/request/pull/203) Fix cookie and redirect bugs and add auth support for HTTPS tunnel (@milewise)
...
- [#217](https://null/mikeal/request/pull/217) need to use Authorization (titlecase) header with Tumblr OAuth (@visnup)
...
- [#224](https://null/mikeal/request/pull/224) Multipart content-type change (@janjongboom)
...
- [#211](https://null/mikeal/request/pull/211) Replace all occurrences of special chars in RFC3986 (@chriso)
...
- [#240](https://null/mikeal/request/pull/240) don't error when null is passed for options (@polotek)
...
- [#243](https://null/mikeal/request/pull/243) Dynamic boundary (@zephrax)
...
- [#246](https://null/mikeal/request/pull/246) Fixing the set-cookie header (@jeromegn)
...
- [#260](https://null/mikeal/request/pull/260) fixed just another leak of 'i' (@sreuter)
- [#255](https://null/mikeal/request/pull/255) multipart allow body === '' ( the empty string ) (@Filirom1)
- [#249](https://null/mikeal/request/pull/249) Fix for the fix of your (closed) issue #89 where self.headers[content-length] is set to 0 for all methods (@sethbridges)
...
- [#261](https://null/mikeal/request/pull/261) Setting 'pool' to 'false' does NOT disable Agent pooling (@timshadel)
- [#262](https://null/mikeal/request/pull/262) JSON test should check for equality (@timshadel)
...
- [#265](https://null/mikeal/request/pull/265) uncaughtException when redirected to invalid URI (@naholyr)
- [#263](https://null/mikeal/request/pull/263) Bug in OAuth key generation for sha1 (@nanodocumet)
- [f4b87cf](https://github.com/mikeal/request/commit/f4b87cf439453b3ca1d63e85b3aeb3373ee1f17e) I'm not OCD seriously (@TehShrike)
- [#268](https://null/mikeal/request/pull/268) I'm not OCD seriously (@TehShrike)
...
- [#273](https://null/mikeal/request/pull/273) Pipe back pressure issue (@mafintosh)
...
- [#279](https://null/mikeal/request/pull/279) fix tests with boundary by injecting boundry from header (@benatkin)
...
- [#282](https://null/mikeal/request/pull/282) OAuth Authorization header contains non-"oauth_" parameters (@jplock)
...
- [#241](https://null/mikeal/request/pull/241) Composability updates suggested by issue #239 (@polotek)
- [#284](https://null/mikeal/request/pull/284) Remove stray `console.log()` call in multipart generator. (@bcherry)
...
- [#272](https://null/mikeal/request/pull/272) Boundary begins with CRLF? (@proksoup)
- [#214](https://null/mikeal/request/pull/214) documenting additional behavior of json option (@jphaas)
- [#207](https://null/mikeal/request/pull/207) Fix #206 Change HTTP/HTTPS agent when redirecting between protocols (@isaacs)
...
- [#280](https://null/mikeal/request/pull/280) Like in node.js print options if NODE_DEBUG contains the word request (@Filirom1)
...
- [#290](https://null/mikeal/request/pull/290) A test for #289 (@isaacs)
- [#293](https://null/mikeal/request/pull/293) Allow parser errors to bubble up to request (@mscdex)
...
- [#317](https://null/mikeal/request/pull/317) Workaround for #313 (@isaacs)
- [#318](https://null/mikeal/request/pull/318) Pass servername to tunneling secure socket creation (@isaacs)
...
- [#326](https://null/mikeal/request/pull/326) Do not try to remove listener from an undefined connection (@CartoDB)
- [#322](https://null/mikeal/request/pull/322) Fix + test for piped into request bumped into redirect. #321 (@alexindigo)
...
- [#320](https://null/mikeal/request/pull/320) request.defaults() doesn't need to wrap jar() (@redbadger)
...
- [#343](https://null/mikeal/request/pull/343) Allow AWS to work in more situations, added a note in the README on its usage (@nathan-lafreniere)
...
- [#332](https://null/mikeal/request/pull/332) Fix #296 - Only set Content-Type if body exists (@Marsup)
...
- [#355](https://null/mikeal/request/pull/355) stop sending erroneous headers on redirected requests (@azylman)
...
- [#360](https://null/mikeal/request/pull/360) Delete self._form along with everything else on redirect (@jgautier)
...
- [#361](https://null/mikeal/request/pull/361) Don't create a Content-Length header if we already have it set (@danjenkins)
...
- [#362](https://null/mikeal/request/pull/362) Running `rfc3986` on `base_uri` in `oauth.hmacsign` instead of just `encodeURIComponent` (@jeffmarshall)
...
- [#363](https://null/mikeal/request/pull/363) rfc3986 on base_uri, now passes tests (@jeffmarshall)
- [bfe2791](https://github.com/mikeal/request/commit/bfe2791f596b749eed6961159d41a404c3aba0d0) oauth fix. (@mikeal)
- [#344](https://null/mikeal/request/pull/344) Make AWS auth signing find headers correctly (@nathan-lafreniere)
...
- [#369](https://null/mikeal/request/pull/369) Don't remove x_auth_mode for Twitter reverse auth (@drudge)
...
- [#370](https://null/mikeal/request/pull/370) Twitter reverse auth uses x_auth_mode not x_auth_type (@drudge)
...
- [#374](https://null/mikeal/request/pull/374) Correct Host header for proxy tunnel CONNECT (@ypocat)
...
- [#375](https://null/mikeal/request/pull/375) Fix for missing oauth_timestamp parameter (@jplock)
...
- [#376](https://null/mikeal/request/pull/376) Headers lost on redirect (@kapetan)
...
- [#380](https://null/mikeal/request/pull/380) Fixes missing host header on retried request when using forever agent (@mac-)
- [#381](https://null/mikeal/request/pull/381) Resolving "Invalid signature. Expected signature base string: " (@landeiro)
...
- [#388](https://null/mikeal/request/pull/388) Ensure "safe" toJSON doesn't break EventEmitters (@othiym23)
...
- [#398](https://null/mikeal/request/pull/398) Add more reporting to tests (@mmalecki)
...
- [#403](https://null/mikeal/request/pull/403) Optimize environment lookup to happen once only (@mmalecki)
...
- [#338](https://null/mikeal/request/pull/338) Add more auth options, including digest support (@nylen)
- [fd2e2fa](https://github.com/mikeal/request/commit/fd2e2fa1e6d580cbc34afd3ae1200682cecb3cf9) Fixed a typo. (@jerem)
- [#415](https://null/mikeal/request/pull/415) Fixed a typo. (@jerem)
...
- [#430](https://null/mikeal/request/pull/430) Respect specified {Host,host} headers, not just {host} (@andrewschaaf)
...
- [#433](https://null/mikeal/request/pull/433) Added support for HTTPS cert & key (@indexzero)
...
- [#444](https://null/mikeal/request/pull/444) protect against double callbacks on error path (@spollack)
- [#448](https://null/mikeal/request/pull/448) Convenience method for PATCH (@mloar)
...
- [#413](https://null/mikeal/request/pull/413) rename googledoodle.png to .jpg (@nfriedly)
...
- [#310](https://null/mikeal/request/pull/310) Twitter Oauth Stuff Out of Date; Now Updated (@joemccann)
...
- [#454](https://null/mikeal/request/pull/454) Destroy the response if present when destroying the request (clean merge) (@mafintosh)
- [#429](https://null/mikeal/request/pull/429) Copy options before adding callback. (@nrn)
- [e0e0fb4](https://github.com/mikeal/request/commit/e0e0fb451f17945a02203639e4836aa327b4e30b) hawk 0.9.0 (@hueniverse)
- [#456](https://null/mikeal/request/pull/456) hawk 0.9.0 (@hueniverse)
...
- [#462](https://null/mikeal/request/pull/462) if query params are empty, then request path shouldn't end with a '?' (merges cleanly now) (@jaipandya)
- [#460](https://null/mikeal/request/pull/460) hawk 0.10.0 (@hueniverse)
- [#461](https://null/mikeal/request/pull/461) Strip the UTF8 BOM from a UTF encoded response (@kppullin)
...
- [#471](https://null/mikeal/request/pull/471) Using querystring library from visionmedia (@kbackowski)
...
- [#473](https://null/mikeal/request/pull/473) V0.10 compat (@isaacs)
...
- [#475](https://null/mikeal/request/pull/475) Use `unescape` from `querystring` (@shimaore)
...
- [#479](https://null/mikeal/request/pull/479) Changing so if Accept header is explicitly set, sending json does not ov... (@RoryH)
...
- [#490](https://null/mikeal/request/pull/490) Empty response body (3-rd argument) must be passed to callback as an empty string (@Olegas)
...
- [#498](https://null/mikeal/request/pull/498) Moving response emit above setHeaders on destination streams (@kenperkins)
...
- [#513](https://null/mikeal/request/pull/513) add 'localAddress' support (@yyfrankyy)
- [#512](https://null/mikeal/request/pull/512) Make password optional to support the format: http://username@hostname/ (@pajato1)
- [#508](https://null/mikeal/request/pull/508) Honor the .strictSSL option when using proxies (tunnel-agent) (@iriscouch)
...
- [#502](https://null/mikeal/request/pull/502) Fix POST (and probably other) requests that are retried after 401 Unauthorized (@nylen)
...
- [#510](https://null/mikeal/request/pull/510) Add HTTP Signature support. (@digitalbazaar)
...
- [#519](https://null/mikeal/request/pull/519) Update internal path state on post-creation QS changes (@incredible-labs)
...
- [#520](https://null/mikeal/request/pull/520) Fixing test-tunnel.js (@noway421)
...
- [#523](https://null/mikeal/request/pull/523) Updating dependencies (@noway421)
...
- [#521](https://null/mikeal/request/pull/521) Improving test-localAddress.js (@noway421)
- [#503](https://null/mikeal/request/pull/503) Fix basic auth for passwords that contain colons (@tonistiigi)
- [#497](https://null/mikeal/request/pull/497) Added redirect event (@Cauldrath)
- [297a9ea](https://github.com/mikeal/request/commit/297a9ea827655e5fb406a86907bb0d89b01deae8) fix typo (@fredericosilva)
- [#532](https://null/mikeal/request/pull/532) fix typo (@fredericosilva)
...
- [#536](https://null/mikeal/request/pull/536) Allow explicitly empty user field for basic authentication. (@mikeando)
...
- [#542](https://null/mikeal/request/pull/542) Expose Request class (@ifit)
...
- [#541](https://null/mikeal/request/pull/541) The exported request function doesn't have an auth method (@tschaub)
- [3040bbe](https://github.com/mikeal/request/commit/3040bbe5de846811151dab8dc09944acc93a338e) Fix redirections, (@criloz)
- [#564](https://null/mikeal/request/pull/564) Fix redirections (@NebTex)
...
- [#568](https://null/mikeal/request/pull/568) use agentOptions to create agent when specified in request (@SamPlacette)
...
- [#581](https://null/mikeal/request/pull/581) Fix spelling of "ignoring." (@bigeasy)
- [#544](https://null/mikeal/request/pull/544) Update http-signature version. (@digitalbazaar)
...
- [#587](https://null/mikeal/request/pull/587) Global cookie jar disabled by default (@threepointone)
...
- [#589](https://null/mikeal/request/pull/589) Prevent setting headers after they are sent (@wpreul)
